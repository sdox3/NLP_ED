...
class DataProcessor(object):
    ...
    def _read_tsv(cls, input_file, quotechar=None):
        ...
        with open(input_file, "r", encoding = 'utf-8') as f: # 수정
...
class ColaProcessor(DataProcessor):
    ...
    def _create_examples(self, lines, set_type):
        ...
        return examples
### kyoungman.bae @ 19-05-28 @ 
def convert_examples_to_features(examples, label_list, max_seq_length, tokenizer): # 수정
...
def main():
    ...
    # cola or mrpc를 소문자로 변경
    task_name = args.task_name.lower()

    if task_name not in processors:
        raise ValueError("Task not found: %s" % (task_name))

    processor = processors[task_name]() # processor 지정 cola or mrpc
    ### kyoungman.bae @ 19-05-28 
    ...
    ### kyoungman.bae @ 19-05-28
    # tokenizer 설정, 토크나이저로 미리 만들어 놓은 vocab을 기준으로 정렬하는듯
